"""
Django settings for withered_field_44152 project.
...
ROOT_URLCONF = 'withered_field_44152.urls'
...
WSGI_APPLICATION = 'withered_field_44152.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_field_44152 API",
    "DESCRIPTION": "API documentation for withered_field_44152 App",
    "VERSION": "v1",
}
