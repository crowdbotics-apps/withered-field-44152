...
## Project Structure
    ...
    ├── withered_field_44152  # Django project configurations
...
1. Clone this repo and `cd withered_field_44152`
...
2. Clone this repo and `cd withered_field_44152`
